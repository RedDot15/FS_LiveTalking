    ...
    async def process(self, character_inputs: CharacterInputs):
        try:
            ...
            return CharacterOutputs(
                avatar_file_info = {
                    "filename": character_inputs.avatar_image.filename,
                    "content_type":  character_inputs.avatar_image.content_type
                },
                knowledge_file_info = {
                    "filename": character_inputs.knowledge_file.filename,
                    "content_type":  character_inputs.knowledge_file.content_type
                },
                audio_file_info = {
                    "filename": character_inputs.audio_file.filename,
                    "content_type":  character_inputs.audio_file.content_type
                }
            )
