...
_abbreviations = {
    ...
    "vi": [
        (re.compile(r"\bông\.", re.IGNORECASE), "ông"),
        (re.compile(r"\bbà\.", re.IGNORECASE), "bà"),
        (re.compile(r"\banh\.", re.IGNORECASE), "anh"),
        (re.compile(r"\bchị\.", re.IGNORECASE), "chị"),
        (re.compile(r"\bts\.", re.IGNORECASE), "tiến sĩ"),
        (re.compile(r"\bths\.", re.IGNORECASE), "thạc sĩ"),
        (re.compile(r"\bpgs\.", re.IGNORECASE), "phó giáo sư"),
        (re.compile(r"\bgs\.", re.IGNORECASE), "giáo sư"),
        (re.compile(r"\bcn\.", re.IGNORECASE), "cử nhân"),
        (re.compile(r"\bks\.", re.IGNORECASE), "kỹ sư"),
        (re.compile(r"\bcty\.", re.IGNORECASE), "công ty"),
        (re.compile(r"\btp\.", re.IGNORECASE), "thành phố"),
        (re.compile(r"\bq\.", re.IGNORECASE), "quận"),
        (re.compile(r"\bp\.", re.IGNORECASE), "phường"),
    ]
...
_ordinal_re = {
    ...
    "vi": re.compile(r"([0-9]+)(?:\s*(?:thứ|th|hạng))", re.IGNORECASE),
}
