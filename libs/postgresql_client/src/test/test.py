...
postgres = PostgreSQL(user=POSTGRES__USER,
...
if __name__ == '__main__':
    ...
    from postgresql_client.model.schema import (
        User, 
        Role, 
        Permission
    )

    p = Permission(name='DELETE_USER')
    ...
    u = User(username='admin2', password='admin', name='admin', avatar_url='url', email='sample@mail.com', phone_number='03632738')
